    ...
    <div>
        <div id="app-dokument">
            ...
            <div class="page-wrapper">
                <app-page-header title="Sekretess"></app-page-header>
                <div class="doc-wrapper">
                    <div class="container">
                        <div id="doc-header" class="doc-header text-center">
                            <h1 class="doc-title"><span aria-hidden="true" class="icon icon_info_alt"></span> Sekretess</h1>
                            <div class="meta"><em class="far fa-clock"></em> Senast uppdaterad: Mars 10, 2020</div>
                        </div><!--//doc-header-->
                        <div id="showcase" class="doc-body row">
                            <div class="doc-content col-md-9 col-12 order-1">
                                <div class="content-inner">
                                    ...
                                    <p>Enkelt uses the collected data for various purposes:</p>
                                    <ul>
                                    ...
                                    <p>If you are located outside Finland and choose to provide information to us, please note that we transfer the data, including Personal Data, to Finland and process it there.</p>
                                    <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
                                    <p>Enkelt will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
    
                                    <h2>Disclosure Of Data</h2>
    
                                    <h3>Legal Requirements</h3>
                                    <p>Enkelt may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                                    <ul>
                                        <li>To comply with a legal obligation</li>
                                        <li>To protect and defend the rights or property of Enkelt</li>
...
<script>
    ...
    export default {
        name: 'PrivacyPolicy',
        components: {AppPageHeader, ScrollToTopBtn, AppFooterImg, AppFooter},
        mounted() {
            document.title = 'Enkelt - Sekretess'
        }
    }
</script>